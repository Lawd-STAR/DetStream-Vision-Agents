        ...
        if shutdown_event.is_set():
            ...
            if agent_task and not agent_task.done():
                ...
                try:
                    ...
                    logger.warning(f"⚠️ Agent didn't stop within {shutdown_timeout}s, forcing shutdown")
...
def run(ctx: click.Context, timeout: float) -> None:
    ...
    click.echo("💡 Use start_dispatcher() in your agent scripts for proper lifecycle management")
