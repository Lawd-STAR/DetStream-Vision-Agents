    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        if client is not None:
            ...
            self._is_async = isinstance(client, AsyncOpenAI) or hasattr(client, '__aenter__') or str(type(client).__name__).startswith('AsyncMock')
        else:
    ...
    async def generate_chat_stream(
        ...
        **kwargs: Any
        ...
        try:
            ...
            self.logger.debug(f"Generating streaming chat completion with {len(messages)} messages")
