...
class OpenAIRealtimeLLM(realtime.Realtime):
    """
    ...
    def __init__(
        ...
        self.Realtime = True  # This is an Realtime-capable LLM
    ...
    async def _create_connection(self):
        ...
        try:
            ...
            # Note: Realtime base class stores the provider in self.provider_name
    ...
    async def _send_audio_pcm_async(self, pcm_data, target_rate: int):
        ...
        if audio_bytes:
            # Emit input event using Realtime helper
    ...
    def simple_response(
        ...
        Note: In Realtime mode, responses are typically generated automatically
