...
class TestXAI:
    ...
    async def test_chat_response_generation(self, check_api_key):
        ...
        chat = client.chat.create(
            model="grok-beta",
            messages=[system("You are a helpful assistant. Keep responses to one sentence.")]
        )
    ...
    async def test_conversation_flow(self, check_api_key):
        ...
        chat = client.chat.create(
            model="grok-beta",
            messages=[system("You are a helpful assistant. Keep all responses to one sentence.")]
        )
